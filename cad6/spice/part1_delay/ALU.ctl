...
.TRAN 1e-12 62n START=0 

* ==========================
*       Measurement
* ==========================
.MEASURE TRAN case1_tpdf_alu_15 TRIG V(op0<0>) VAL='vdd*0.5' RISE=1
+                               TARG V(alu_out<15>) VAL='vdd*0.5' FALL=1

.MEASURE TRAN case1_tpdf_n TRIG V(op0<0>) VAL='vdd*0.5' RISE=1
+                          TARG V(n_flag) VAL='vdd*0.5' FALL=1

.MEASURE TRAN case1_tpdr_c TRIG V(op0<0>) VAL='vdd*0.5' RISE=1
+                          TARG V(c_flag) VAL='vdd*0.5' RISE=1

.MEASURE TRAN case2_tpdr_alu_15 TRIG V(op1<0>) TD=4.0e-9 VAL='vdd*0.5' FALL=1
+                               TARG V(alu_out<15>) VAL='vdd*0.5' RISE=1

.MEASURE TRAN case2_tpdr_n TRIG V(op1<0>) TD=4.0e-9 VAL='vdd*0.5' FALL=1
+                          TARG V(n_flag) VAL='vdd*0.5' RISE=1

.MEASURE TRAN case2_tpdf_c TRIG V(op1<0>) TD=4.0e-9 VAL='vdd*0.5' FALL=1
+                          TARG V(c_flag) VAL='vdd*0.5' FALL=1

.MEASURE TRAN case3_tpdr_alu_15 TRIG V(op1<0>) TD=8.0e-9 VAL='vdd*0.5' RISE=1
+                               TARG V(alu_out<15>) VAL='vdd*0.5' RISE=1

.MEASURE TRAN case3_tpdr_n TRIG V(op1<0>) TD=8.0e-9 VAL='vdd*0.5' RISE=1
+                          TARG V(n_flag) VAL='vdd*0.5' RISE=1

.MEASURE TRAN case3_tpdr_c TRIG V(op1<0>) TD=8.0e-9 VAL='vdd*0.5' RISE=1
+                          TARG V(c_flag) VAL='vdd*0.5' RISE=1

.MEASURE TRAN case4_tpdr_alu_15 TRIG V(op0<0>) TD=12.0e-9 VAL='vdd*0.5' RISE=1
+                               TARG V(alu_out<15>) VAL='vdd*0.5' RISE=2

.MEASURE TRAN case4_tpdr_n TRIG V(op0<0>) TD=12.0e-9 VAL='vdd*0.5' RISE=1
+                          TARG V(n_flag) VAL='vdd*0.5' RISE=2

.MEASURE TRAN case4_tpdr_c TRIG V(op0<0>) TD=12.0e-9 VAL='vdd*0.5' RISE=1
+                          TARG V(c_flag) VAL='vdd*0.5' RISE=1

.MEASURE TRAN case4_tpdf_v TRIG V(op0<0>) TD=12.0e-9 VAL='vdd*0.5' RISE=1
+                          TARG V(v_flag) VAL='vdd*0.5' FALL=1

.MEASURE TRAN case5_tpdf_alu_15 TRIG V(op1<0>) TD=16.0e-9 VAL='vdd*0.5' FALL=1
+                               TARG V(alu_out<15>) VAL='vdd*0.5' FALL=1

.MEASURE TRAN case5_tpdf_n TRIG V(op1<0>) TD=16.0e-9 VAL='vdd*0.5' FALL=1
+                          TARG V(n_flag) VAL='vdd*0.5' FALL=1

.MEASURE TRAN case5_tpdr_v TRIG V(op1<0>) TD=16.0e-9 VAL='vdd*0.5' FALL=1
+                          TARG V(v_flag) VAL='vdd*0.5' RISE=1

.MEASURE TRAN case6_tpdf_alu_15 TRIG V(op1<0>) TD=20.0e-9 VAL='vdd*0.5' RISE=1
+                               TARG V(alu_out<15>) VAL='vdd*0.5' FALL=1

.MEASURE TRAN case6_tpdf_n TRIG V(op1<0>) TD=20.0e-9 VAL='vdd*0.5' RISE=1
+                          TARG V(n_flag) VAL='vdd*0.5' FALL=1

.MEASURE TRAN case6_tpdf_v TRIG V(op1<0>) TD=20.0e-9 VAL='vdd*0.5' RISE=1
+                          TARG V(v_flag) VAL='vdd*0.5' FALL=1

.MEASURE TRAN case7_tpdf_alu_15 TRIG V(op1<0>) TD=28.5e-9 VAL='vdd*0.5' RISE=1
+                               TARG V(alu_out<15>) VAL='vdd*0.5' FALL=1

.MEASURE TRAN case7_tpdf_n TRIG V(op1<0>) TD=28.5e-9 VAL='vdd*0.5' RISE=1
+                          TARG V(n_flag) VAL='vdd*0.5' FALL=1

.MEASURE TRAN case7_tpdf_v TRIG V(op1<0>) TD=28.5e-9 VAL='vdd*0.5' RISE=1
+                          TARG V(v_flag) VAL='vdd*0.5' FALL=1

.MEASURE TRAN case1_fix_tpdf_alu_15 TRIG V(op0<0>) TD=32.5e-9 VAL='vdd*0.5' RISE=1
+                                   TARG V(alu_out<15>) VAL='vdd*0.5' FALL=1

.MEASURE TRAN case1_fix_tpdf_n TRIG V(op0<0>) TD=32.5e-9 VAL='vdd*0.5' RISE=1
+                              TARG V(n_flag) VAL='vdd*0.5' FALL=1

.MEASURE TRAN case1_fix_tpdr_c TRIG V(op0<0>) TD=32.5e-9 VAL='vdd*0.5' RISE=1
+                              TARG V(c_flag) VAL='vdd*0.5' RISE=1

.MEASURE TRAN case2_fix_tpdr_alu_15 TRIG V(op1<0>) TD=36e-9 VAL='vdd*0.5' FALL=1
+                                   TARG V(alu_out<15>) VAL='vdd*0.5' RISE=1

.MEASURE TRAN case2_fix_tpdr_n TRIG V(op1<0>) TD=36e-9 VAL='vdd*0.5' FALL=1
+                              TARG V(n_flag) VAL='vdd*0.5' RISE=1

.MEASURE TRAN case2_fix_tpdf_c TRIG V(op1<0>) TD=36e-9 VAL='vdd*0.5' FALL=1
+                              TARG V(c_flag) VAL='vdd*0.5' FALL=1

.MEASURE TRAN case6_fix_tpdf_alu_15 TRIG V(op1<0>) TD=40.5e-9 VAL='vdd*0.5' RISE=1
+                                   TARG V(alu_out<15>) VAL='vdd*0.5' FALL=1

.MEASURE TRAN case6_fix_tpdf_n TRIG V(op1<0>) TD=40.5e-9 VAL='vdd*0.5' RISE=1
+                              TARG V(n_flag) VAL='vdd*0.5' FALL=1

.MEASURE TRAN case6_fix_tpdf_c TRIG V(op1<0>) TD=40.5e-9 VAL='vdd*0.5' RISE=1
+                              TARG V(c_flag) VAL='vdd*0.5' RISE=1

.MEASURE TRAN case4_fix_tpdr_alu_15 TRIG V(op0<0>) TD=44.5e-9 VAL='vdd*0.5' RISE=1
+                                   TARG V(alu_out<15>) VAL='vdd*0.5' RISE=1

.MEASURE TRAN case4_fix_tpdr_n TRIG V(op0<0>) TD=44.5e-9 VAL='vdd*0.5' RISE=1
+                              TARG V(n_flag) VAL='vdd*0.5' RISE=1

.MEASURE TRAN case4_fix_tpdf_v TRIG V(op0<0>) TD=44.5e-9 VAL='vdd*0.5' RISE=1
+                              TARG V(v_flag) VAL='vdd*0.5' FALL=1

.MEASURE TRAN case7_fix_tpdf_alu_15 TRIG V(op1<1>) TD=48.5e-9 VAL='vdd*0.5' RISE=1
+                                   TARG V(alu_out<15>) VAL='vdd*0.5' FALL=1

.MEASURE TRAN case7_fix_tpdf_n TRIG V(op1<1>) TD=48.5e-9 VAL='vdd*0.5' RISE=1
+                              TARG V(n_flag) VAL='vdd*0.5' FALL=1

.MEASURE TRAN case7_fix_tpdr_c TRIG V(op1<1>) TD=48.5e-9 VAL='vdd*0.5' RISE=1
+                              TARG V(c_flag) VAL='vdd*0.5' RISE=1

.MEASURE TRAN case5_fix_tpdf_alu_15 TRIG V(op1<0>) TD=52.5e-9 VAL='vdd*0.5' FALL=1
+                                   TARG V(alu_out<15>) VAL='vdd*0.5' FALL=1

.MEASURE TRAN case5_fix_tpdf_n TRIG V(op1<0>) TD=52.5e-9 VAL='vdd*0.5' FALL=1
+                              TARG V(n_flag) VAL='vdd*0.5' FALL=1

.MEASURE TRAN case5_fix_tpdr_v TRIG V(op1<0>) TD=52.5e-9 VAL='vdd*0.5' FALL=1
+                              TARG V(v_flag) VAL='vdd*0.5' RISE=1

.MEASURE TRAN case3_fix_tpdr_c TRIG V(op1<0>) TD=56.6e-9 VAL='vdd*0.5' RISE=1
+                              TARG V(c_flag) VAL='vdd*0.5' RISE=1
