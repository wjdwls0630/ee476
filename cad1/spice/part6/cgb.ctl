...
Vvi vi 0 PWL 0 0 0.49e-9 0 0.5e-9 vdd
...
*       Measurement
* ==========================
.MEASURE TRAN cgb INTEGRAL '-I(vi)' FROM=0.49e-9 TO=0.5e-9 

.MEASURE TRAN Qg_049 FIND lx14(x1.m0) AT=0.49e-9 
.MEASURE TRAN Qg_05 FIND lx14(x1.m0) AT=0.5e-9 
.MEASURE TRAN cgb_cal PARAM='Qg_05-Qg_049'
* ==========================
*          PROBE
* ==========================
