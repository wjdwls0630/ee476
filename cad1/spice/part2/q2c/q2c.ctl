...
x1 vi vo q2c L=60e-9 W=1e-6 R='RES'
* ==========================
*         Stimulus
* ==========================
...
Vvi vi 0 PULSE 0 vdd 0 0.02e-9 0.02e-9 0.23e-9 0.5e-9
...
.TRAN 0.01e-9 3e-9 START=0 

* ==========================
*       Measurement
* ==========================
.MEASURE TRAN rise_time TRIG V(vo) VAL='vdd*0.2' RISE=1
+                       TARG V(vo) VAL='vdd*0.8' RISE=1

.MEASURE TRAN fall_time TRIG V(vo) VAL='vdd*0.8' FALL=1
